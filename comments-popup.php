...
<meta property="fb:admins" content="1075980345" />
...
<?php else : ?>
	<p>
	  <input type="text" name="author" id="author" class="textarea input-box2" value="<?php echo esc_attr($comment_author); ?>" size="28" tabindex="1" />
	   <label for="author">Name</label>
	</p>

	<p>
	  <input type="text" name="email" id="email" class="input-box2" value="<?php echo esc_attr($comment_author_email); ?>" size="28" tabindex="2" />
	   <label for="email">E-mail</label>
	</p>

	<p>
	  <input type="text" name="url" id="url" class="input-box2" value="<?php echo esc_attr($comment_author_url); ?>" size="28" tabindex="3" />
...
<?php endif; ?>
	...
	<br />
	  <textarea name="comment" class="input-box2-big" id="comment" cols="70" rows="4" tabindex="4"></textarea>
	</p>
